...
class IceCreamApp:
    def __init__(self, ice_cream_stand):
        ...
        self.root = Tk()
        self.root.title("Маленький Единорог")
...
ice_cream_stand = IceCreamStand("улица Стремянная дом 11", "10:00-19:00")
ice_cream_stand.add_flavor("Клубничное")
ice_cream_stand.add_flavor("Банановое")
ice_cream_stand.add_flavor("Пломбир")
ice_cream_stand.add_flavor("Баблгам")
ice_cream_stand.add_flavor("КремБрюле")
